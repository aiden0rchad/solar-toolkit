...
export const TOOLS = [
  ...
  { id: 'simple-roi', title: 'Is solar worth it?', navLabel: 'Solar Savings (Simple)', icon: Sun, section: 'main', tier: 'free', component: SimpleSolarROI },
  { id: 'consult', title: 'Client Consult', navLabel: 'Client Consult', icon: Presentation, section: 'main', tier: 'pro', component: ConsultWizard, needsExport: true },
  { id: 'calculator', title: 'ROI Calculator', navLabel: 'ROI Calculator (Pro)', icon: LayoutDashboard, section: 'main', tier: 'pro', component: ROICalculator, needsExport: true },
  ...
  { id: 'blackout', title: 'Blackout Simulator', navLabel: 'Blackout Simulator', icon: Battery, section: 'main', tier: 'free', component: BlackoutSimulator, needsExport: true },
  { id: 'bill', title: 'Smart Bill Decoder', navLabel: 'Smart Bill Decoder', icon: Search, section: 'main', tier: 'free', component: BillDecoder, needsExport: true },
  { id: 'proposal', title: 'Proposal Generator', navLabel: 'Proposal Generator', icon: FileText, section: 'main', tier: 'pro', component: ProposalGenerator },
  { id: 'nem1', title: 'NEM 1.0', navLabel: 'NEM 1.0 (Legacy)', icon: History, section: 'education', tier: 'free', component: NEM1Explainer },
  { id: 'nem2', title: 'NEM 2.0', navLabel: 'NEM 2.0 (Transition)', icon: History, section: 'education', tier: 'free', component: NEM2Explainer },
  { id: 'nem3', title: 'NEM 3.0', navLabel: 'NEM 3.0 (Current)', icon: Presentation, section: 'education', tier: 'free', component: NEM3Explainer },
];
