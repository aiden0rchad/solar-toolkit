...
export const TOOLS = [
  ...
  { id: 'consult', title: 'Client Consult', navLabel: 'Client Consult', icon: Presentation, section: 'main', tier: 'pro', component: null, needsExport: true },
  { id: 'calculator', title: 'ROI Calculator', navLabel: 'ROI Calculator (Pro)', icon: LayoutDashboard, section: 'main', tier: 'pro', component: null, needsExport: true },
